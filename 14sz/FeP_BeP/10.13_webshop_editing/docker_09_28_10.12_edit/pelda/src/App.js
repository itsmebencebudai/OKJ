...
app.post('/reg', (req, res) => {
    ...
    const sql = 'INSERT INTO `Users` (name,email,pw,account_number) VALUES("' + req.body.name + '","' + req.body.email + '","' + req.body.password + '","' + req.body.accountNumber + '");';
    const sql2 = 'INSERT INTO `Users` (name,email,pw,account_number) values(?,?,?,?)';
    console.log(sql);
