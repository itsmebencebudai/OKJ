...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2024. Máj 24. 07:19
-- Kiszolgáló verziója: 10.4.24-MariaDB
-- PHP verzió: 8.1.6

CREATE DATABASE fuggohidak CHARACTER SET 'utf8' COLLATE 'utf8_hungarian_ci';
USE fuggohidak;
...
--
-- Adatbázis: `fuggohidak`
--

-- --------------------------------------------------------

--
-- Tábla szerkezet ehhez a táblához `hudak`
--
...
--
-- A tábla adatainak kiíratása `hidak`
--

INSERT INTO `hidak` (`Helyezes`, `Hid`, `Hely`, `Orszag`, `Hossz`, `Ev`) VALUES
